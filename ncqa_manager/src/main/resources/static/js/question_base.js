...
$("#createFileSureBut").click(function () {
        ...
        if (typeof(v1) == "undefined" || typeof(v2) == "undefined") {
            ...
            if (whereIn == 0) {
                //修改
                xmlHttp.open("POST", "http://localhost:4397/question/updateQuestionBase", "true");
                ...
                xmlHttp.open("POST", "http://localhost:4397/question/insertQuestionBase", "true");
                xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
$("#make_sure").click(function () {
    ...
    alert(id);
    var xmlHttp = createXMLHttpRequest();
    xmlHttp.open("POST", "http://localhost:4397/question/deleteQuestionBase", "true");
    xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xmlHttp.send("id=" + id);
    xmlHttp.onreadystatechange = function () {
...
function getChoose(isInArgue) {
    if (!isInArgue) {
        var xmlHttp = createXMLHttpRequest();
        xmlHttp.open("GET", "http://localhost:4397/question/findAllKind", "false");
        xmlHttp.send(null);
        xmlHttp.onreadystatechange = function () {
