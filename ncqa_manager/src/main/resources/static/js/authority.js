...
$("#addSure").click(function(){
    ...
    xmlHttp.open("POST", "http://127.0.0.1:4397/authority/addUser", "true");
...
function submitEvent(id) {
    ...
    xmlHttp.open("POST", "http://127.0.0.1:4397/authority/modify", "true");
    xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function changePage(id) {
    window.location.href="http://127.0.0.1:4397/authority/getIndexByGroup?group_id="+id;
