...
$("#addSure").click(function(){
    ...
    xmlHttp.open("POST", "http://localhost:4397/authority/addUser", "true");
...
function submitEvent(id) {
    ...
    xmlHttp.open("POST", "http://localhost:4397/authority/modify", "true");
    xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function changePage(id) {
    window.location.href="http://localhost:4397/authority/getIndexByGroup?group_id="+id;
