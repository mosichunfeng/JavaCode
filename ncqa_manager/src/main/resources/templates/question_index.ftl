            ...
            <div class="xi">
                <form class="form-inline">
                    ...
                    <#if result.basePage.pageNo != 1>
                        <a class="btn btn-success " href="http://127.0.0.1:4397/question/pageQuery?remark1=1">首页</a>
                        <a class="btn btn-success "
                           href="http://127.0.0.1:4397/question/pageQuery?remark1=1&pageNo=${result.basePage.pageNo-1}&rowSrt=${result.basePage.rowSrt-result.basePage.pageSize}">上一页</a>
                    </#if>
                    <#if (result.basePage.pageNo<result.basePage.pages)>
                        <a class="btn btn-success"
                           href="http://127.0.0.1:4397/question/pageQuery?remark1=1&pageNo=${result.basePage.pageNo+1}&rowSrt=${result.basePage.rowSrt+result.basePage.pageSize}">下一页</a>
                        <a class="btn btn-success"
                           href="http://127.0.0.1:4397/question/pageQuery?remark1=1&pageNo=${result.basePage.pages}">尾页</a>
                    </#if>
            ...
            <div class="xi">
                <form class="form-inline">
                    ...
                    <#if result2.basePage.pageNo != 1>
                        <a class="btn btn-success " href="http://127.0.0.1:4397/question/pageQuery?remark1=2">首页</a>
                        <a class="btn btn-success "
                           href="http://127.0.0.1:4397/question/pageQuery?remark1=2&pageNo=${result2.basePage.pageNo-1}&rowSrt=${result2.basePage.rowSrt-result2.basePage.pageSize}">上一页</a>
                    </#if>
                    <#if (result2.basePage.pageNo<result2.basePage.pages)>
                        <a class="btn btn-success"
                           href="http://127.0.0.1:4397/question/pageQuery?remark1=2&pageNo=${result2.basePage.pageNo+1}&rowSrt=${result2.basePage.rowSrt+result2.basePage.pageSize}">下一页</a>
                        <a class="btn btn-success"
                           href="http://127.0.0.1:4397/question/pageQuery?remark1=2&pageNo=${result2.basePage.pages}">尾页</a>
                    </#if>
                            <input type="text" class="form-control input-medium" id="page_index" placeholder="页数">
                            <button class="btn btn-success ">跳页</button>
                        </div>
