            ...
            <div class="form-group">
                <div class="input-inline input-inline">
                    <#if result.basePage.pageNo != 1>
                        <a class="btn btn-success " href="http://www.jiandev.cn:4397/question/pageQuery">首页</a>
                        <a class="btn btn-success " href="http://www.jiandev.cn:4397/question/pageQuery?pageNo=${result.basePage.pageNo-1}&rowSrt=${result.basePage.rowSrt-result.basePage.pageSize}">上一页</a>
                    </#if>
                    <#if (result.basePage.pageNo<result.basePage.pages)>
                        <a class="btn btn-success" href="http://www.jiandev.cn:4397/question/pageQuery?pageNo=${result.basePage.pageNo+1}&rowSrt=${result.basePage.rowSrt+result.basePage.pageSize}">下一页</a>
                        <a class="btn btn-success" href="http://www.jiandev.cn:4397/question/pageQuery?pageNo=${result.basePage.pages}">尾页</a>
                    </#if>
